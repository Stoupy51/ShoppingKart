...
#> shopping_kart:v1.3.3/load/enumerate
#
...
execute if score #shopping_kart.major load.status matches 1 if score #shopping_kart.minor load.status matches 3 unless score #shopping_kart.patch load.status matches 3.. run scoreboard players set #shopping_kart.patch load.status 3
