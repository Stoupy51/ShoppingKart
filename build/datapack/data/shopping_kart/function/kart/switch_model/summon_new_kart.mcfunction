...
execute if score #model shopping_kart.data matches 54 run summon strider ~ ~ ~ {Tags:["shopping_kart.new_kart"]}
execute if score #model shopping_kart.data matches 55 run summon turtle ~ ~ ~ {Tags:["shopping_kart.new_kart"]}
