...
# @executed	as @a & at @s
#
# @within	shopping_kart:v1.4.1/tick [ as @a & at @s ]
#
...
execute if score @s shopping_kart.current_model matches ..-1 run scoreboard players set @s shopping_kart.current_model 55
execute if score @s shopping_kart.current_model matches 56.. run scoreboard players set @s shopping_kart.current_model 0
