...
#> shopping_kart:kart/physics/apply_motion
#
...
execute if score #surface shopping_kart.data matches 2 store result score @s shopping_kart.motion_x run data get storage shopping_kart:main Motion[0] 9777777
execute if score #surface shopping_kart.data matches 2 store result score @s shopping_kart.motion_z run data get storage shopping_kart:main Motion[2] 9777777
